...
import com.citibank.dto.ErrorDetails;
import com.citibank.exceptions.CustomerNotFoundException;
...
public class CitiExceptionHandler {
	...
	public ResponseEntity<ErrorDetails> handle500(Exception ex){
		...
		details.setDate(LocalDateTime.now());
		details.setName("team.it@city.com");
		details.setMessage("Some internal Server Error Occured. Please try again later");
